/*
 * 日期：2020/2/12 上午11:44
 * 文件名：SellerUserController.java
 * 文件路径：/Users/xuda/Library/Mobile Documents/com~apple~CloudDocs/ideaProject/selltest/src/main/java/com/qxholy/selltest/controller/SellerUserController.java
 * 项目名称：selltest
 * 模块名称：selltest
 * 作者：xuda
 */
...
public class SellerUserController {
    ...
    public ModelAndView login(@RequestParam("openid") String openid,
        ...
        return new ModelAndView("redirect:" + projectUrlConfig.getBread() + "/sell/seller/order/list");
